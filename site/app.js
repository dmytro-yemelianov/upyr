(() => {
  ...
  const ukrainian = {
    ...
    featureFeedbackCopy: "Необов’язкові прапорці мови та три локальні саундпаки додають короткі звуки подій і клавіш. Ретро-кліки та синтезовані Anime Reactions створюються на пристрої без записів голосу.",
