(() => {
  ...
  const ukrainian = {
    ...
    releaseNote: "Універсальний для Apple Silicon та Intel · macOS 11+ · статус підпису вказано для кожного релізу",
    ...
    downloadCopy: "Завантажте найновішу доступну попередню версію macOS, перевіривши статус підпису в нотатках до релізу, або перегляньте й зберіть кожен рядок самостійно.",
